...
exports.formatHeader = function (attributes, id, app, mac) {
    ...
    return 'Oz id="' + id + '", app="' + Hoek.escapeHeaderAttribute(app) + '", ts="' + attributes.ts + (attributes.ext ? '", ext="' + Hoek.escapeHeaderAttribute(attributes.ext) : '') + (attributes.dlg ? '", dlg="' + Hoek.escapeHeaderAttribute(attributes.dlg) : '') + '", mac="' + mac + '"';
};
