...
internals.setErrorHeader = function (err, callback) {

    err.wwwAuthenticateHeader = 'Oz' + (err.message ? ' error="' + err.message + '"' : '');
    callback(err);
};
...
exports.formatHeader = function (attributes, id, app, mac) {
    ...
    return 'Oz id="' + id + '", app="' + internals.escapeHeaderAttribute(app) + '", ts="' + attributes.ts + (attributes.ext ? '", ext="' + internals.escapeHeaderAttribute(attributes.ext) : '') + '", mac="' + mac + '"';
};
...
exports.generateHeader = function (request, ticket, attributes) {
    ...
    var mac = exports.mac(request, ticket, attributes);
    return exports.formatHeader(attributes, ticket.id, ticket.app, mac);
};


internals.escapeHeaderAttribute = function (attribute) {
