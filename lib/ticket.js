...
exports.issue = function (app, user, encryptionPassword, options, callback) {
    ...
    Crypto.randomBits(Settings.ticket.secretBits, function (err, random) {
        ...
        Crypto.encrypt(encryptionPassword, Settings.ticket.encryptionKey, ticketString, function (err, encrypted, key) {
            ...
            var hmac = Crypto.hmacPassword(encryptionPassword, Settings.ticket.integrityKey, macBaseString, function (err, mac) {
...
exports.parse = function (id, encryptionPassword, callback) {
    ...
    Crypto.hmacPassword(encryptionPassword, macOptions, macBaseString, function (err, mac) {
        ...
        Crypto.decrypt(encryptionPassword, decryptOptions, encrypted, function (err, decrypted) {
